...
public class IntensifyImageView extends View implements IntensifyImage,
    ...
    protected void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDelegate.setScaleType(IntensifyImage.ScaleType.valueOf(
                a.getInt(R.styleable.IntensifyImageView_scaleType, IntensifyImage.ScaleType.FIT_CENTER.nativeInt)));
